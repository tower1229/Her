...
- `timeline_status`
- `timeline_repair`
- diagnostic commands for inspecting trace / writer state / daily log status.
...
Tasks:
1. Add `timeline_status`.
2. Add `timeline_repair`.
...
3. add `timeline_status` as the first maintenance tool.
