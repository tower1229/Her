...
export const TIMELINE_PLUGIN_DESCRIPTION =
  'OpenClaw timeline v2 runtime with canonical timeline_resolve/timeline_status tools and lifecycle helpers.';

export const TIMELINE_TOOL_NAMES = ['timeline_resolve', 'timeline_status'] as const;
